...
- [Generic SQL Injection Payloads](#generic-sql-injection-payloads)   
- [Generic Error Based Payloads](#generic-error-based-payloads)  
- [Generic Time Based SQL Injection Payloads](#generic-time-based-sql-injection-payloads)   
- [Generic Union Select Payloads](#generic-union-select-payloads)    
- [SQL Injection Auth Bypass Payloads](#sql-injection-auth-bypass-payloads)   
...
Paylaods From : https://github.com/payloadbox/sql-injection-payload-list  
